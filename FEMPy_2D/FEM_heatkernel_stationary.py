...
p_unitsquare = UnitSquareMesh(0.001)
plt.rcParams["figure.dpi"] = 150



def StationaryEquationAssembler(points, simplices, hull, timesteps = 200, delta_t = 0.005):
    ...
    #InRectangle =  BoundaryPointsInRectangle(-1,1,-1,1, points, OnlyBoundaryPoints=False)
    Boundary_Outside = BoundaryPointsOutsideRectangle(0.01,0.99,0.01,0.99,points, OnlyBoundaryPoints= False)
    InRectangle = []
    ...
    DirichletBC(Boundary_Outside, 22)
...
StationaryEquationAssembler(p_unitsquare[0],p_unitsquare[1],p_unitsquare[2], timesteps = 100, delta_t = 0.2)
